...
//
// All copy comes from messages/{id,en}.json under the `driversCar`
// namespace.
...
export async function generateMetadata() {
  const t = await getTranslations('driversCar')
  return {
    title:       t('metaTitle'),
...
export default async function CarDriversLandingPage() {
  const t = await getTranslations('driversCar')
  return (
    <main
