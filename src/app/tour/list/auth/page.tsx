        ...
        <div className="max-w-md mx-auto px-4 pt-6 pb-24 space-y-6">
          <header className="text-center space-y-2">
            ...
            <p className="text-[13px] text-muted leading-snug">
              Pilih cara masuk untuk mulai listing kamu sebagai tour guide di City Riders.
            </p>
          </header>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[12px] text-muted mt-0.5">
                Daftar gratis. Sudah jadi City Rider driver? Listing tour guide gratis.
          ...
          <div className="card p-4 space-y-2">
            ...
            <ul className="text-[12px] text-muted leading-snug space-y-1">
              <li>• <span className="font-extrabold text-ink">Driver City Rider aktif:</span> 1 listing tour guide gratis (sudah termasuk subscription Rp 38K/bulan kamu).</li>
