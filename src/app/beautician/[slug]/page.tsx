  ...
  return (
    <Shell backgroundImageUrl={pageBackgroundImageUrl}>
      ...
      <div className="px-4 pb-6 max-w-2xl mx-auto space-y-3 pt-3">
        ...
        {/* mig 0224 — "Pay deposit via QRIS" block. Renders below the
            Contact CTA when the vendor has uploaded a static QRIS image.
            Kita2u never custodies funds — the customer scans the
            merchant's own QR and pays direct. Cross-border QRIS spans
            ID/MY/SG/TH/PH (~580M consumers). Structural moat vs
            Linktree / Stan Store / Beacons, none of which ship native
            QRIS. */}
        {p.qr_payment_url && (
          <section
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[13px] sm:text-[14px] text-gray-700 leading-relaxed mt-2">
                  Scan with any banking app or e-wallet — GoPay, OVO, DANA, ShopeePay, LinkAja, BCA, Mandiri, BRI, Maybank, KBank, DBS PayLah! Payment goes direct to {p.display_name}; Kita2u never custodies funds.
                </p>
