          ...
          <div className="flex flex-col p-4 sm:p-5">
            ...
            <div className="flex items-center justify-between gap-2 shrink-0">
              <div className="min-w-0">
                <h1 className="text-[18px] sm:text-[20px] font-black tracking-tight text-bg leading-tight">
                  Beauticians in {cityLabel}
                </h1>
                <p className="text-[12px] font-bold text-[#71717A] leading-tight mt-0.5 truncate">
                  Beauty pros in {cityLabel} · Makeup · Nails · Hair · Spa
                </p>
              </div>
              <Link
                href="/beautician/signup"
                onClick={() => haptic.tap()}
                aria-label="List your beautician business"
            ...
            <div className="mt-3 relative shrink-0">
              <input
                ...
                placeholder="Search beauticians — name, salon, area…"
                aria-label="Search beauticians"
