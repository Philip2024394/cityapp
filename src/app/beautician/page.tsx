...
// ============================================================================
// /beautician — Marketplace ported to the /places shell (2026-05-28).
...
// taller than /places — beautician content is richer).
//
...
function MarketplaceInner() {
  ...
  const t       = useTranslations('verticals.beautician')
        ...
        >
          <div className="flex flex-col p-4 sm:p-5">
            ...
            <div className="flex items-center justify-between gap-2 shrink-0">
              ...
              <Link
                href="/signup?vertical=beautician"
                onClick={() => haptic.tap()}
            ...
            <div
              ...
              role="tablist"
              aria-label="Filter beauticians by category"
            >
                ...
                <div className="py-10 text-center">
                  <p className="text-[13px] font-bold text-[#71717A] leading-snug">
                    {query.trim()
                      ...
                      : 'No beauticians in this category yet. Try a different filter.'}
                  </p>
                </div>
              )}
            ...
            <p className="mt-3 text-center text-[12px] text-[#52525B] font-bold leading-snug px-2 shrink-0">
              ...
              — you pay your beautician directly.
            </p>
          </div>
        </div>
      </div>
...
// ─────────────────────────────────────────────────────────────────────────────
// BeauticianRowCard — landscape card, ~22% taller than /places PlaceRowCard
...
// ─────────────────────────────────────────────────────────────────────────────
function BeauticianRowCard({
  provider: p,
  onOpen,
}: {
  provider: BeauticianProviderPublic
  onOpen: () => void
}) {
    ...
    >
      <header className="relative z-30 pt-safe">
        <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          >
            {/* Kita2u text wordmark. Was a CityDrivers PNG (yellow pin
                logo at ImageKit) which is the wrong brand on this
                marketplace — beautician + every other vertical lives
                under Kita2u, not CityDrivers. */}
            <span
