...
// /dashboard/bus/privacy — long-form Privacy Policy editor for car / bus
...
export default function BusDriverPrivacyPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!user) { router.replace('/login?next=/dashboard/bus/privacy'); return }
