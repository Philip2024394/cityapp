'use client'
// ============================================================================
// /dashboard/bus/qr — Printable profile QR for car/bus/truck drivers
// ----------------------------------------------------------------------------
...
export default function BusQrPage() {
  ...
  if (state.kind === 'no_slug')     return <FullPageMessage cta={{ href: '/dashboard/bus/info', label: 'Set up profile' }}>Set your public slug to generate a QR.</FullPageMessage>
        ...
        <div className="cr-flier-head">
          <div className="cr-flier-brand">
            {driver.vehicle_type === 'bus' ? 'Bus driver' :
             driver.vehicle_type === 'truck' ? 'Truck driver' : 'Bus driver'}
          </div>
