'use client'
// ============================================================================
// /dashboard/bus/subscription — CityDrivers Rp 38.000/month subscription
// ----------------------------------------------------------------------------
...
export default function BusSubscriptionPage() {
  ...
  if (state.kind === 'unauth')      return <FullPageMessage cta={{ href: '/login?next=/dashboard/bus/subscription', label: 'Sign in' }}>Sign in to manage your subscription.</FullPageMessage>
...
function StatusCard({ sub }: { sub: SubStatus }) {
  ...
  const body = isExpired
    ? 'Renew below to come back online in the public bus marketplace.'
    : 'Pay your first month to publish your listing in the public bus marketplace.'
