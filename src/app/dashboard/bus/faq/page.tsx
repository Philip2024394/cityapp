...
// /dashboard/bus/faq — FAQ editor for car / bus / truck drivers. Mirrors
...
export default function BusDriverFaqPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!user) { router.replace('/login?next=/dashboard/bus/faq'); return }
