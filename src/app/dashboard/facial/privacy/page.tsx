...
// /dashboard/facial/privacy — long-form Privacy Policy editor. Same
...
export default function FacialPrivacyPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!data?.session?.user) { router.replace('/login?next=/dashboard/facial/privacy'); return }
    setLoading(true)
    try {
