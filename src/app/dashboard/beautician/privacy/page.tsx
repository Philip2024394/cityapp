...
// /dashboard/beautician/privacy — long-form Privacy Policy editor. Same
...
export default function BeauticianPrivacyPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!data?.session?.user) { router.replace('/login?next=/dashboard/beautician/privacy'); return }
    setLoading(true)
    try {
