...
// /dashboard/beautician/faq — FAQ editor. Backed by faq_items (jsonb)
...
export default function BeauticianFaqPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!data?.session?.user) { router.replace('/login?next=/dashboard/beautician/faq'); return }
    setLoading(true)
    try {
