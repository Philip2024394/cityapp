// /dashboard/catering layout — mounts BookingAlertProvider so the
// "You have a WhatsApp message" alert pops on every subpage. Also mounts
// CateringPageSwitcher (Studio tier multi-location chip, task 11/12)
...
import CateringPageSwitcher from '@/components/dashboard/CateringPageSwitcher'

export default async function CateringDashboardLayout({
  children,
}: {
