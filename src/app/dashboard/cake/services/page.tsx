...
export default function CakeServicesPage() {
  ...
  if (!provider) {
    return (
      <Shell>
        <div className="px-4 pt-20 max-w-md mx-auto text-center">
          <h1 className="text-[20px] font-black text-white mb-2">Not a cake & bakery business yet</h1>
    ...
    <Shell>
      <div className="px-4 pt-3 pb-32 max-w-lg mx-auto">
        <header className="mb-5 flex items-center justify-between gap-3">
          <div>
            <Link href="/dashboard/cake" className="text-[12px] font-bold text-white/60 hover:text-white inline-block">← Dashboard</Link>
            <h1 className="text-[24px] font-black text-white leading-tight">Cake catalog &amp; portfolio</h1>
            <p className="text-[13px] text-white/70 mt-1">Pick kategori kue, set per-cake + paket bundle, and add cake photos that clients browse.</p>
          </div>
        </header>
