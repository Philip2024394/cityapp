...
export default function MoverServicesPage() {
  ...
  if (!provider) {
    return (
      <Shell>
        <div className="px-4 pt-20 max-w-md mx-auto text-center">
          <h1 className="text-[20px] font-black text-white mb-2">Not a mover business yet</h1>
    ...
    <Shell>
      <div className="px-4 pt-3 pb-32 max-w-lg mx-auto">
        <header className="mb-5 flex items-center justify-between gap-3">
          <div>
            <Link href="/dashboard/mover" className="text-[12px] font-bold text-white/60 hover:text-white inline-block">← Dashboard</Link>
            <h1 className="text-[24px] font-black text-white leading-tight">Armada &amp; Layanan</h1>
            <p className="text-[13px] text-white/70 mt-1">Pick vehicle + services, set anchor price + paket rumah-penuh rate, and add Armada & Pindahan photos that owners browse.</p>
          </div>
        </header>
