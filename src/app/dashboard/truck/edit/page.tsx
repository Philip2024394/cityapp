'use client'
// ============================================================================
// /dashboard/truck/edit — Page design (banner picker)
// ----------------------------------------------------------------------------
// Mirrors /dashboard/car/edit. Truck drivers pick the hero backdrop shown
// on their public /truck/[slug] profile. We persist to
// drivers.cover_image_url; null falls back to the vehicle-type default
// resolved by getDefaultBanner() (DEFAULT_TRUCK_HERO when curated, or the
// CAR fallback until TRUCK_BANNERS lands).
//
...
// this page scoped to what the customer actually sees on /truck/[slug].
// ============================================================================
...
export default function TruckEditPage() {
  ...
  if (state.kind === 'unauth')      return <FullPageMessage cta={{ href: '/login?next=/dashboard/truck/edit', label: 'Sign in' }}>Sign in to edit your page design.</FullPageMessage>
...
// ============================================================================
// Shell — composed layout matching the car/edit reference
// ============================================================================
  ...
  return (
    <main className="relative min-h-[100dvh] bg-[#F5F5F4] text-[#0A0A0A]">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-5 pt-4 pb-24">
        ...
        {/* Hero strip — yellow gradient, mirrors car/edit pattern */}
        <div
        ...
        {/* Banner picker — curated TRUCK_BANNERS + upload + paste URL */}
...
function BannerPickerSection({ row, onSaved }: { row: DriverRow; onSaved: () => void }) {
  ...
  const curatedUrls = useMemo(() => new Set(TRUCK_BANNERS.map((b) => b.url)), [])
  ...
  // picks a thumbnail. Mirrors car/edit's auto-save pattern.
...
// ----------------------------------------------------------------------------
// Section card wrapper — yellow tinted icon to match car/edit
// ----------------------------------------------------------------------------
function Section({
