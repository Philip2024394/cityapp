...
//   - back-link points to /dashboard/truck
//   - copy says "truck" instead of "car" in titles + admin WA pre-fill
//   - POST body sends vehicleType=truck (the API accepts car/truck/...).
//
...
// Page
// ============================================================================
export default function TruckSubscriptionPage() {
  ...
  if (state.kind === 'unauth')      return <FullPageMessage cta={{ href: '/login?next=/dashboard/truck/subscription', label: 'Sign in' }}>Sign in to manage your subscription.</FullPageMessage>
...
function StatusCard({ sub }: { sub: SubStatus }) {
  ...
  const body = isExpired
    ? 'Renew below to come back online in the public truck marketplace.'
    : 'Pay your first month to publish your listing in the public truck marketplace.'
