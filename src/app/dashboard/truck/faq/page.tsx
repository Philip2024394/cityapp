...
// /dashboard/truck/faq — FAQ editor for truck drivers. Mirrors the
...
// (jsonb) + faq_enabled (boolean) on the drivers table — Phase 2
// migration adds these columns; until then the save will fail silently.
//
...
export default function TruckDriverFaqPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!user) { router.replace('/login?next=/dashboard/truck/faq'); return }
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-0.5">
                <h1 className="text-[20px] font-black leading-tight text-black truncate">Truck Driver FAQ</h1>
    ...
    <div className="relative rounded-2xl bg-gray-50 border border-gray-200 p-3 space-y-2">
      ...
      <div className="space-y-1">
        ...
        <input
          ...
          placeholder="Do you handle pindahan rumah?"
          maxLength={Q_MAX}
      ...
      <div className="space-y-1">
        ...
        <textarea
          ...
          placeholder="Yes — pindahan rumah is one of our most common jobs. Tell me the address, floor, and approximate volume so I can quote helpers and hours."
          maxLength={A_MAX}
          rows={3}
