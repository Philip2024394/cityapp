'use client'
// ============================================================================
// /dashboard/truck/stats — Traffic + share analytics for truck drivers
// ----------------------------------------------------------------------------
// Mirror of /dashboard/car/stats — same shape, same data plumbing. Trucks
// share the `drivers` table with cars/buses (mig 0001:36), so the join
// key is still user_id and the source column buckets (qr / wa_share /
// social / direct) are identical. KPI labels stay vehicle-agnostic
// (views, share clicks, WhatsApp taps, rating) so no copy adaptation.
//
// Only deltas vs the car version:
//   - function name → TruckStatsPage
//   - back-link href → /dashboard/truck
// ============================================================================
...
export default function TruckStatsPage() {
