'use client'
// ============================================================================
// /dashboard/truck/hotspots — Truck driver city busy area live stats
// ----------------------------------------------------------------------------
// Mirror of /dashboard/car/hotspots. Same MOCK_ZONES, same
// BusyHoursChartLight, same coaching footer. Trucks carry parcels/cargo,
// so the subtitle stays "passengers / parcels" — same generic copy as the
// car page (the demo dataset is shared and isn't truck-specific yet).
// ============================================================================
...
export default function TruckHotspotsPage() {
