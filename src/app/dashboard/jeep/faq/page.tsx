...
// /dashboard/jeep/faq — FAQ editor for car / bus / truck drivers. Mirrors
// the beautician/faq UX 1:1: debounced auto-save (1s after last edit) for
...
export default function JeepDriverFaqPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!user) { router.replace('/login?next=/dashboard/jeep/faq'); return }
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-0.5">
                <h1 className="text-[20px] font-black leading-tight text-black truncate">Driver FAQ</h1>
