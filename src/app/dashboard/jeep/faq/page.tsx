'use client'
// ============================================================================
// /dashboard/jeep/faq — FAQ editor for the jeep profile "Contact Us" surface.
// ----------------------------------------------------------------------------
...
// Page entry
// ============================================================================
export default function JeepFaqPage() {
  ...
  if (state.kind === 'unauth') {
    ...
    return (
      <FullMsg
        cta={{ href: '/login?next=/dashboard/jeep/faq', label: 'Sign in' }}
        onMount={() => { router.replace('/login?next=/dashboard/jeep/faq') }}
      >
        Sign in to edit your FAQ.
      </FullMsg>
    )
  }
  if (state.kind === 'no_driver')   return <FullMsg cta={{ href: '/signup/jeep', label: 'Create jeep driver profile' }}>No jeep driver profile yet.</FullMsg>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[12.5px] text-[#0A0A0A]/75 leading-snug">
                Shown at the top of the <strong>Contact Us</strong> panel on your jeep profile.
