...
// /dashboard/jeep/terms — long-form Terms editor for car / bus / truck
...
export default function JeepDriverTermsPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!user) { router.replace('/login?next=/dashboard/jeep/terms'); return }
