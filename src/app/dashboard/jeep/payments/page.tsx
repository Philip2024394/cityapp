'use client'
// ============================================================================
// /dashboard/jeep/payments — Payment methods (Phase 1B real implementation)
// ----------------------------------------------------------------------------
// Replaces the placeholder stub. Mirrors the beautician payments page UX:
...
// Page entry
// ============================================================================
export default function JeepPaymentsPage() {
  ...
  if (state.kind === 'unauth')      return <FullMsg cta={{ href: '/login?next=/dashboard/jeep/payments', label: 'Sign in' }}>Sign in to edit your payment methods.</FullMsg>
