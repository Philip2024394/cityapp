...
export default function CarwashServicesPage() {
  ...
  if (!provider) {
    return (
      <Shell>
        <div className="px-4 pt-20 max-w-md mx-auto text-center">
          <h1 className="text-[20px] font-black text-[#0A0A0A] mb-2">Not a car wash business yet</h1>
    ...
    <Shell>
      <div className="px-4 pt-3 pb-32 max-w-lg mx-auto">
        <header className="mb-5 flex items-center justify-between gap-3">
          <div>
            <Link href="/dashboard/car-wash" className="text-[12px] font-bold text-gray-500 hover:text-gray-900 inline-block">← Dashboard</Link>
            <h1 className="text-[24px] font-black text-[#0A0A0A] leading-tight">Layanan & Tarif</h1>
            <p className="text-[13px] text-gray-600 mt-1">Pick vehicle + wash specialties, set anchor price + paket detailing/coating rate, and add Hasil Cucian photos that customers browse.</p>
          </div>
        </header>
