...
// /dashboard/car/faq — FAQ editor for car / bus / truck drivers. Mirrors
...
export default function CarDriverFaqPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!user) { router.replace('/login?next=/dashboard/car/faq'); return }
