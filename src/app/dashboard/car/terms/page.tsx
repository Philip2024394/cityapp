...
// /dashboard/car/terms — long-form Terms editor for car / bus / truck
...
export default function CarDriverTermsPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!user) { router.replace('/login?next=/dashboard/car/terms'); return }
