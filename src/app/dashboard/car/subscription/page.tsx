'use client'
// ============================================================================
// /dashboard/car/subscription — CityRiders Rp 38.000/month subscription
// ----------------------------------------------------------------------------
...
// Page
// ============================================================================
export default function CarSubscriptionPage() {
  ...
  if (state.kind === 'unauth')      return <FullPageMessage cta={{ href: '/login?next=/dashboard/car/subscription', label: 'Sign in' }}>Sign in to manage your subscription.</FullPageMessage>
...
function StatusCard({ sub }: { sub: SubStatus }) {
  ...
  const body = isExpired
    ? 'Renew below to come back online in the public car marketplace.'
    : 'Pay your first month to publish your listing in the public car marketplace.'
      ...
      >
        ...
        <div className="px-5 pt-6 pb-5">
          ...
          <p className="text-[13px] text-black/65 mt-1 leading-snug">
            Pay Rp {SUBSCRIPTION_MONTHLY_IDR.toLocaleString('id-ID')} to keep your car listing live for 30 days.
          </p>
