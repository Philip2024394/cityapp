'use client'
// ============================================================================
// /dashboard/car/payments — Payment methods (Phase 1B real implementation)
// ----------------------------------------------------------------------------
...
// Page entry
// ============================================================================
export default function CarPaymentsPage() {
  ...
  if (state.kind === 'unauth')      return <FullMsg cta={{ href: '/login?next=/dashboard/car/payments', label: 'Sign in' }}>Sign in to edit your payment methods.</FullMsg>
