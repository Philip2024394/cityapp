...
// /dashboard/car/privacy — long-form Privacy Policy editor for car / bus
...
export default function CarDriverPrivacyPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!user) { router.replace('/login?next=/dashboard/car/privacy'); return }
