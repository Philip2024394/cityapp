'use client'
// ============================================================================
// /dashboard/car/qr — Printable profile QR for car/bus/truck drivers
// ----------------------------------------------------------------------------
...
export default function CarQrPage() {
  ...
  if (state.kind === 'no_slug')     return <FullPageMessage cta={{ href: '/dashboard/car/info', label: 'Set up profile' }}>Set your public slug to generate a QR.</FullPageMessage>
        ...
        <div className="cr-flier-head">
          <div className="cr-flier-brand">
            {driver.vehicle_type === 'bus' ? 'Bus driver' :
             driver.vehicle_type === 'truck' ? 'Truck driver' : 'Car driver'}
          </div>
