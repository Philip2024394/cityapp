'use client'
// ============================================================================
// /dashboard/rider/payments — Payment methods (bike-rider mirror)
// ----------------------------------------------------------------------------
// Mirrors /dashboard/car/payments with pure copy swap (rider context):
...
//   The toggles here describe WHICH METHODS THE RIDER ACCEPTS DIRECTLY
...
export default function RiderPaymentsPage() {
  ...
  if (state.kind === 'unauth')      return <FullMsg cta={{ href: '/login?next=/dashboard/rider/payments', label: 'Sign in' }}>Sign in to edit your payment methods.</FullMsg>
