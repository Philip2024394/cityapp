'use client'
// ============================================================================
// /dashboard/rider/stats — Traffic + share analytics for bike riders (ojek)
// ----------------------------------------------------------------------------
// Mirrors the beautician stats page but in the bike-rider yellow palette.
// Pulls from public.provider_profile_views (mig 0072) filtered to
// provider_type='driver' + provider_id=<drivers.user_id>. Bike riders are
// stored in the same drivers table (discriminator is vehicle_type='bike').
// Drivers' table PK is user_id (mig 0001:36), so that's the join key —
// not a separate id column like the other verticals.
//
