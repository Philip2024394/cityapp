'use client'
// ============================================================================
// /dashboard/rider/hotspots — Bike-rider city busy area live stats
// ----------------------------------------------------------------------------
// Sister page to the legacy /dashboard/hotspots but redrawn in the new
// light-theme rider dashboard palette (white surfaces, gray borders,
// charcoal text, yellow accent). Shares the same MOCK_ZONES data + the
// BusyHoursChartLight chart with the car variant — see
// /dashboard/car/hotspots/page.tsx for the mirror.
//
// Data lineage: still MOCK for Phase 1. Production swap-in is server-
// side aggregation of quote_events bucketed into H3 hexagons (see
// note at top of src/data/mockHotspots.ts).
// ============================================================================
...
export default function RiderHotspotsPage() {
  ...
  // Today's demand peak hours (top 3)
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[12.5px] font-bold opacity-80 leading-snug">
                Where customers want a ride RIGHT NOW. Updated every 15 min.
              </p>
            </div>
          </div>
        </section>
            ...
            .map(({ z, cat }) => (
              ...
              >
                ...
                <div className="text-right shrink-0 text-[12px] tabular-nums">
                  ...
                  <div className="font-bold text-black/45">{z.supply} riders</div>
                </div>
              </div>
            ))}
        </section>
