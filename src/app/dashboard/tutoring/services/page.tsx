...
export default function TutoringServicesPage() {
  ...
  if (!provider) {
    return (
      <Shell>
        <div className="px-4 pt-20 max-w-md mx-auto text-center">
          <h1 className="text-[20px] font-black text-white mb-2">Not a tutor yet</h1>
    ...
    <Shell>
      <div className="px-4 pt-3 pb-32 max-w-lg mx-auto">
        <header className="mb-5 flex items-center justify-between gap-3">
          <div>
            <Link href="/dashboard/tutoring" className="text-[12px] font-bold text-white/60 hover:text-white inline-block">← Dashboard</Link>
            <h1 className="text-[24px] font-black text-white leading-tight">Package catalog &amp; portfolio</h1>
            <p className="text-[13px] text-white/70 mt-1">Pick mata pelajaran, set per-pertemuan + paket bundle, and add Belajar Bareng photos that students browse.</p>
          </div>
        </header>
