...
// POST /api/fitness/[slug]/book
// Customer submits a session booking request for a personal trainer.
...
export async function POST(req: Request, ctx: { params: Promise<{ slug: string }> }) {
  ...
  // busy_dates is a date[] on fitness_providers (mig 0089-equiv).
  ...
  if (error) {
    console.error('[fitness/book] insert failed', { code: error.code, message: error.message })
