...
import { ALL_SPECIALTIES, MAX_PET_SPECIALTIES, type PetSpecialty } from '@/lib/pet/types'
...
export async function POST(req: Request) {
  ...
  const specialties = (body.specialties ?? [])
    ...
    .slice(0, MAX_PET_SPECIALTIES) as PetSpecialty[]
  ...
  if (error) {
    console.error('[pet/signup] insert failed', { code: error.code, message: error.message })
