...
// Public preview of the WhatsApp Status flyer. No auth — useful for
// QA screenshots and quickly diffing the template. The auth-gated
// download lives at /api/handyman/me/flyer.
