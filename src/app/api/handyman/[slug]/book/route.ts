...
export async function POST(req: Request, ctx: { params: Promise<{ slug: string }> }) {
  ...
  // busy_dates is a date[] on handyman_providers (mig 0089).
  ...
  if (error) {
    console.error('[handyman/book] insert failed', { code: error.code, message: error.message })
