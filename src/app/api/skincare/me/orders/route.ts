...
// GET /api/skincare/me/orders
// ----------------------------------------------------------------------------
// Returns every order for the signed-in skincare provider, newest first. Used by
// /dashboard/skincare/orders. Vendor sees full rows including customer
...
export async function GET(req: Request) {
  ...
  if (error) {
    console.error('[skincare/me/orders] fetch failed', { code: error.code, message: error.message })
