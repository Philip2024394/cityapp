...
// POST /api/yoga/[slug]/book
// Customer submits a session booking request for a yoga teacher.
...
export async function POST(req: Request, ctx: { params: Promise<{ slug: string }> }) {
  ...
  // busy_dates is a date[] on yoga_providers (mig 0089-equiv).
  ...
  if (error) {
    console.error('[yoga/book] insert failed', { code: error.code, message: error.message })
