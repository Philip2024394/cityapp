...
export async function GET(req: Request) {
  ...
  // Task 11/12 — Studio tier multi-location: one user can own many
  // beautician_providers rows. The dashboard passes ?slug=<x> so the
  ...
  // covers Free/Pro accounts that only have one row to begin with.
