...
// GET /api/beautician/me/orders
// ----------------------------------------------------------------------------
// Returns every order for the signed-in beautician, newest first. Used by
// /dashboard/beautician/orders. Vendor sees full rows including customer
