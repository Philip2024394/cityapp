...
// POST /api/cake/[slug]/book
// Customer submits a booking request for a cake / bakery. She sees it
...
// WhatsApp; this row just records the request so the bakery knows who
// and when.
//
...
export async function POST(req: Request, ctx: { params: Promise<{ slug: string }> }) {
  ...
  // busy_dates is a date[] on cake_providers (mig 0089-equiv).
  ...
  if (error) {
    console.error('[cake/book] insert failed', { code: error.code, message: error.message })
