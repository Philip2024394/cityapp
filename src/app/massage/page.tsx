...
//
// Compliance posture: IndoCity is a software directory (PM 12/2019).
          ...
          <div className="flex flex-col p-4 sm:p-5">
            ...
            <div className="flex items-center justify-between gap-2 shrink-0">
              <div className="min-w-0">
                <h1 className="text-[18px] sm:text-[20px] font-black tracking-tight text-bg leading-tight">
                  Therapists in {cityLabel}
                </h1>
                <p className="text-[12px] font-bold text-[#71717A] leading-tight mt-0.5 truncate">
                  Massage pros in {cityLabel} · Home · Hotel · Villa
                </p>
              </div>
              <Link
                href="/massage/signup"
                onClick={() => haptic.tap()}
                aria-label="List your massage therapist profile"
            ...
            <div className="mt-3 relative shrink-0">
              <input
                ...
                placeholder="Search therapists — name, modality, area…"
...
function Shell({ children }: { children: React.ReactNode }) {
  return (
    <main
      ...
      style={{ color: '#0A0A0A' }}
    >
      {/* Backdrop image — same one used on /explore + landing + /beautician */}
      <div
        aria-hidden
