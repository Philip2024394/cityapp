...
const STRINGS = {
  id: {
    ...
    smallprint: 'Dengan mendaftar, Anda menyetujui komisi 8% per booking, dibayar langsung oleh driver setiap 48 jam. CityDrivers tidak menahan dana.',
  ...
  en: {
    ...
    smallprint: 'By registering you agree to an 8% commission per booking, settled by the driver directly to you every 48 hours. CityDrivers never holds funds.',
