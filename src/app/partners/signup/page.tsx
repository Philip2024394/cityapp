...
const STRINGS = {
  id: {
    ...
    smallprint: 'Dengan mendaftar, Anda menyetujui komisi 8% per booking dan settlement mingguan langsung dari driver. CityDrivers tidak menahan dana.',
  ...
  en: {
    ...
    smallprint: 'By registering you agree to an 8% commission per booking, settled weekly by the driver directly to you. CityDrivers never holds funds.',
