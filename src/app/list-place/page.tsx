...
export const metadata = {
  title: 'List Your Place · CityDrivers',
  description:
    'Daftarkan tempat usahamu di CityDrivers. GRATIS 7 hari pertama, lalu Rp 38.000/bulan atau Rp 350.000/tahun — listing langsung tampil di area kotamu.',
}
      ...
      <main className="max-w-2xl mx-auto px-4 pt-3 pb-24">
        ...
        <header className="mb-6">
          ...
          <p className="mt-2 text-[14px] text-muted leading-snug">
            Tampilkan tempat usahamu di CityDrivers dan biarkan pelanggan kami yang sedang booking
        ...
        <div className="rounded-2xl p-4 bg-gradient-to-br from-brand to-brand2 text-bg shadow-[0_8px_22px_rgba(250,204,21,0.30)] border border-black/85">
          ...
          <p className="text-[13px] font-bold leading-snug">
            Isi detail tempatmu, upload foto, dan kirim — admin CityDrivers akan meninjau dalam
