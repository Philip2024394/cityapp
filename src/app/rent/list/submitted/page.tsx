...
export const metadata = { title: 'Bike listing submitted · CityDrivers' }
    ...
    <>
      ...
      <main className="max-w-xl mx-auto px-4 pt-12 pb-24 text-center">
        ...
        <p className="text-[14px] text-muted leading-snug mb-6">
          Terima kasih! Admin CityDrivers akan meninjau motormu dalam <strong className="text-ink">24–48 jam</strong>.
