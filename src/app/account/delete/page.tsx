...
export const metadata = {
  title: 'Delete your account · Kita2u',
  description: 'How to permanently delete your Kita2u account, profile, and data.',
}
      ...
      <article className="max-w-2xl mx-auto px-4 pt-6 space-y-5">
        ...
        <section className="card p-5 space-y-2.5">
          ...
          <ol className="list-decimal list-inside space-y-1 text-[14px] leading-relaxed text-ink/90">
            <li>Open the Kita2u app or visit <Link href="/login" className="text-brand hover:underline">/login</Link> in a browser</li>
