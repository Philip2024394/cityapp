      ...
      if (next && native) {
        ...
        if (!r.ok) {
          if (r.reason === 'permission_denied') {
            setError('Izin notifikasi ditolak — aktifkan di Settings → Apps → Kita2u → Notifications, lalu coba lagi')
          } else {
    ...
    <div className="space-y-2.5">
      ...
      {!native && (
        ...
        >
          ...
          <div className="flex-1 min-w-0 leading-relaxed">
            Loud alerts require the Kita2u Android app. Install from Google Play for the 10-second booking sound.
          </div>
        </div>
      )}
      ...
      >
        ...
        >
          ...
          <div className="px-5 pb-4 space-y-3 text-[14px] text-[#0A0A0A] leading-relaxed">
            <p>
              Kita2u butuh izin notifikasi sekali saja supaya HP-mu bisa
