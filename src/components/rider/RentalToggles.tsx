...
function ToggleCard({
  ...
  return (
    <button
      ...
      style={{
        borderColor: active ? 'rgba(250,204,21,0.35)' : 'rgba(255,255,255,0.08)',
    ...
    >
      <div
        ...
        style={{
          ...
          border: `1px solid ${active ? 'rgba(250,204,21,0.35)' : 'rgba(255,255,255,0.10)'}`,
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[12px] text-muted mt-0.5 leading-relaxed">{subtitle}</div>
      </div>
      <div
        className="w-12 h-7 rounded-full p-0.5 transition shrink-0"
        style={{ background: active ? '#22C55E' : 'rgba(255,255,255,0.12)' }}
      >
        <div
