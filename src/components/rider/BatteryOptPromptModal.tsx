...
// whitelist City Rider from Android's battery optimization. Fired by
  ...
  return (
    <>
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-label="Izin baterai City Rider"
      ...
      >
        ...
        >
          ...
          <div className="px-5 pb-4 space-y-3 text-[14px] text-ink/90 leading-relaxed">
            <p>
              Untuk tetap <strong>Online</strong> saat layar mati, City Rider
