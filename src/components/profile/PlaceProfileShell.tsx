  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* COMPLIANCE — honest "self-listed venue" line. Kept inline to
            preserve the directory disclaimer without adding a scroll. */}
        <p className="text-[11px] text-gray-400 leading-snug mt-auto pt-1">
          Self-listed venue · IndoCity is a directory ·{' '}
