...
// a 350-char description, and an optional start price (IDR). The
// public /[slug] page renders these as carousel cards with a "View
// Details" popup.
//
...
function ServiceSlotRow({
  ...
  function updateMeta(idx: number, patch: Partial<BeauticianServicePhoto>) {
