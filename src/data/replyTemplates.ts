...
export const REPLY_TEMPLATES: Template[] = [
  {
    ...
    label: 'Salam pembuka',
    text:
      'Halo kak 👋 Terima kasih sudah pesan via Kita2u. Saya siap berangkat sekarang. Ada hal khusus yang perlu saya bawa?',
  },
  {
    id: 'eta',
    category: 'info',
  ...
  },
  {
    ...
    label: 'Sedang sibuk',
    text:
      'Mohon maaf kak, saat ini saya masih dalam pengantaran. Estimasi free dalam ±30 menit. Boleh ditunggu, atau bisa juga pilih rider lain di marketplace Kita2u 🙏',
  },
]
