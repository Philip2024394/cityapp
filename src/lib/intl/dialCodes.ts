// ============================================================================
// dialCodes.ts — country dial-code catalog for the phone-signup prefix picker.
// ----------------------------------------------------------------------------
// Static list — ITU-T E.164 country codes + ISO 3166-1 alpha-2 + flag emoji.
// Used by <PhoneInput> (signup + login) to render the prefix dropdown and to
// auto-select based on the visitor's `kita-country` cookie (set by middleware
// from cf-ipcountry / x-vercel-ip-country).
//
// Why static instead of libphonenumber-js: we only need (a) the dropdown
// list, (b) the dial-code-by-ISO2 lookup. We don't need parsing, formatting,
// or carrier-prefix metadata. libphonenumber-js is ~140kB minified for what
// would be ~6kB of plain data.
//
// E.164 storage: when the user submits, we strip the leading + and prepend
// the dial code's digits to the typed national number — exactly the format
// supabase.auth.signUp({ phone }) expects.
// ============================================================================

export interface DialCode {
  iso2: string  // ISO 3166-1 alpha-2, e.g. 'ID', 'US'
  name: string  // English country name
  dial: string  // E.164 country code without leading + (e.g. '62', '1', '44')
  flag: string  // Unicode flag emoji
}

// Curated alphabetic list. Order = country name A→Z. The <PhoneInput> sorts
// the visible list by name for the dropdown; the iso2 → DialCode lookup is
// built on demand below.
//
// Edge cases:
//   - North America (US, CA + Caribbean) all share '1' — kept distinct so
//     the flag matches the user's country and our analytics know where the
//     signup came from. supabase.auth phone column is country-agnostic so
//     this is purely UX.
//   - Kosovo (XK) and Taiwan (TW) listed under their unofficial flags.
//   - Hong Kong (HK), Macao (MO), Puerto Rico (PR), etc. listed separately
//     even though they roll up to a parent dial code.
export const DIAL_CODES: ReadonlyArray<DialCode> = [
  { iso2: 'AF', name: 'Afghanistan',                        dial: '93',    flag: '🇦🇫' },
  { iso2: 'AL', name: 'Albania',                            dial: '355',   flag: '🇦🇱' },
  { iso2: 'DZ', name: 'Algeria',                            dial: '213',   flag: '🇩🇿' },
  { iso2: 'AS', name: 'American Samoa',                     dial: '1684',  flag: '🇦🇸' },
  { iso2: 'AD', name: 'Andorra',                            dial: '376',   flag: '🇦🇩' },
  { iso2: 'AO', name: 'Angola',                             dial: '244',   flag: '🇦🇴' },
  { iso2: 'AI', name: 'Anguilla',                           dial: '1264',  flag: '🇦🇮' },
  ...
  { iso2: 'BM', name: 'Bermuda',                            dial: '1441',  flag: '🇧🇲' },
  ...
  { iso2: 'VG', name: 'British Virgin Islands',             dial: '1284',  flag: '🇻🇬' },
  ...
  { iso2: 'KY', name: 'Cayman Islands',                     dial: '1345',  flag: '🇰🇾' },
  ...
  { iso2: 'CK', name: 'Cook Islands',                       dial: '682',   flag: '🇨🇰' },
  { iso2: 'CR', name: 'Costa Rica',                         dial: '506',   flag: '🇨🇷' },
  { iso2: 'HR', name: 'Croatia',                            dial: '385',   flag: '🇭🇷' },
  { iso2: 'CU', name: 'Cuba',                               dial: '53',    flag: '🇨🇺' },
  { iso2: 'CW', name: 'Curaçao',                            dial: '599',   flag: '🇨🇼' },
  { iso2: 'CY', name: 'Cyprus',                             dial: '357',   flag: '🇨🇾' },
  { iso2: 'CZ', name: 'Czech Republic',                     dial: '420',   flag: '🇨🇿' },
  { iso2: 'CD', name: 'DR Congo',                           dial: '243',   flag: '🇨🇩' },
  ...
  { iso2: 'FK', name: 'Falkland Islands',                   dial: '500',   flag: '🇫🇰' },
  { iso2: 'FO', name: 'Faroe Islands',                      dial: '298',   flag: '🇫🇴' },
  ...
  { iso2: 'GI', name: 'Gibraltar',                          dial: '350',   flag: '🇬🇮' },
  { iso2: 'GR', name: 'Greece',                             dial: '30',    flag: '🇬🇷' },
  { iso2: 'GL', name: 'Greenland',                          dial: '299',   flag: '🇬🇱' },
  { iso2: 'GD', name: 'Grenada',                            dial: '1473',  flag: '🇬🇩' },
  { iso2: 'GP', name: 'Guadeloupe',                         dial: '590',   flag: '🇬🇵' },
  { iso2: 'GU', name: 'Guam',                               dial: '1671',  flag: '🇬🇺' },
  { iso2: 'GT', name: 'Guatemala',                          dial: '502',   flag: '🇬🇹' },
  { iso2: 'GG', name: 'Guernsey',                           dial: '44',    flag: '🇬🇬' },
  ...
  { iso2: 'XK', name: 'Kosovo',                             dial: '383',   flag: '🇽🇰' },
  ...
  { iso2: 'MS', name: 'Montserrat',                         dial: '1664',  flag: '🇲🇸' },
  ...
  { iso2: 'NC', name: 'New Caledonia',                      dial: '687',   flag: '🇳🇨' },
  ...
  { iso2: 'NU', name: 'Niue',                               dial: '683',   flag: '🇳🇺' },
  { iso2: 'KP', name: 'North Korea',                        dial: '850',   flag: '🇰🇵' },
  { iso2: 'MK', name: 'North Macedonia',                    dial: '389',   flag: '🇲🇰' },
  { iso2: 'MP', name: 'Northern Mariana Islands',           dial: '1670',  flag: '🇲🇵' },
  ...
  { iso2: 'CG', name: 'Republic of the Congo',              dial: '242',   flag: '🇨🇬' },
  { iso2: 'RE', name: 'Réunion',                            dial: '262',   flag: '🇷🇪' },
  ...
  { iso2: 'SX', name: 'Sint Maarten',                       dial: '1721',  flag: '🇸🇽' },
  ...
  { iso2: 'TK', name: 'Tokelau',                            dial: '690',   flag: '🇹🇰' },
  ...
  { iso2: 'TC', name: 'Turks and Caicos',                   dial: '1649',  flag: '🇹🇨' },
...
// O(1) lookup by ISO2. Built lazily so we don't pay the cost on every render.
let _byIso2: Map<string, DialCode> | null = null
function byIso2Map(): Map<string, DialCode> {
  if (_byIso2) return _byIso2
  _byIso2 = new Map(DIAL_CODES.map((c) => [c.iso2, c]))
  return _byIso2
}

/** Lookup a country by its ISO-3166-1 alpha-2 code (e.g. 'ID', 'US'). */
export function findByIso2(iso2: string): DialCode | undefined {
  return byIso2Map().get(iso2.toUpperCase())
}

/** Fallback used when the IP cookie is empty or the country is unknown. */
export const DEFAULT_DIAL = findByIso2('ID')!
