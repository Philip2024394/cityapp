...
export const JEEP_SERVICE_OFFERINGS: readonly ServiceCatalogEntry[] = [
  ...
  },
  {
    id:          'nightlife',
    label_en:    'Nightlife',
    label_id:    'Hiburan Malam',
    description: 'Open-jeep bar + club crawl through Yogya night spots — driver stays sober.',
    rate_model:  'per_destination_package',
    header:      'Nightlife bar + club crawl',
    subtext:     'Open-jeep night ride through Yogya\'s best bars — Lucifer, Sky Garden, Hugo\'s — finishing at a club. Driver waits at each stop and rolls you home safely. Hotel/villa pickup + dropoff included.',
    default_rates: [
      { label: 'Bar crawl (3 venues, 4h)',           idr: 650000 },
      { label: 'Bar crawl + club finish (5 venues, 6h)', idr: 850000 },
      { label: 'Sunset start → full night crawl (8h)',   idr: 1100000 },
    ],
    includes: ['jeep + driver', 'fuel', 'hotel/villa pickup + dropoff', 'designated driver'],
    excludes: ['cover charge + drinks', 'tolls + bridge fees', 'parking', 'food (guests + driver)'],
    imageUrl: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2007_39_26%20PM.png',
  },
  {
    id:          'sunset',
    label_en:    'Sunset',
    label_id:    'Senja',
    description: 'Open-jeep ride to Yogyakarta\'s best sunset viewpoints — Heha, Bukit Bintang, Klangon.',
    rate_model:  'per_destination_package',
    header:      'Sunset viewpoint ride',
    subtext:     'Open-jeep cruise to Yogyakarta\'s best sunset views — Heha Sky View, Bukit Bintang Bantul, Klangon hill, or Pinus Pengger. Driver picks the spot based on cloud cover that day. Hotel/villa pickup + dropoff included.',
    default_rates: [
      { label: 'Heha Sky View sunset (3h)',     idr: 500000 },
      { label: 'Bukit Bintang Bantul (3h)',     idr: 450000 },
      { label: 'Klangon hill sunset (4h)',      idr: 600000 },
      { label: 'Pinus Pengger sunset (3h)',     idr: 500000 },
      { label: 'Two-spot sunset chase (5h)',    idr: 800000 },
    ],
    includes: ['jeep + driver', 'fuel', 'hotel/villa pickup + dropoff'],
    excludes: ['viewpoint entrance tickets', 'tolls + bridge fees', 'parking', 'food (guests + driver)'],
    imageUrl: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2007_43_42%20PM.png',
  },
  {
    id:          'leather',
    label_en:    'Leather',
    label_id:    'Tas Kulit',
    description: 'Manding leather village + handmade bag workshops — watch artisans, shop direct.',
    rate_model:  'per_destination_package',
    header:      'Manding leather workshop tour',
    subtext:     'Jeep ride to Manding Leather Village in Bantul — visit handmade workshops, watch artisans craft bags from scratch, and shop direct from the makers. Driver waits during the workshop visit. Hotel/villa pickup + dropoff included.',
    default_rates: [
      { label: 'Manding leather village (4h)',                       idr: 550000 },
      { label: 'Manding + Kotagede silver combo (6h)',               idr: 800000 },
      { label: 'Manding + Kasongan pottery + Kotagede (full day)',   idr: 1100000 },
    ],
    includes: ['jeep + driver', 'fuel', 'hotel/villa pickup + dropoff'],
    excludes: ['leather purchases', 'workshop demo fees', 'tolls + bridge fees', 'parking', 'food (guests + driver)'],
    imageUrl: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2007_44_43%20PM.png',
  },
  {
    id:          'batik',
    label_en:    'Batik',
    label_id:    'Batik',
    description: 'Giriloyo + Wukirsari batik villages — watch artisans hand-paint with canting.',
    rate_model:  'per_destination_package',
    header:      'Batik workshop tour',
    subtext:     'Jeep ride to the Giriloyo + Wukirsari batik villages near Imogiri. Watch artisans hand-paint batik with canting (wax pen), try painting your own piece, and shop direct from the makers. Driver waits during the workshop. Hotel/villa pickup + dropoff included.',
    default_rates: [
      { label: 'Giriloyo batik village (3h)',                idr: 450000 },
      { label: 'Giriloyo + Wukirsari batik combo (5h)',      idr: 650000 },
      { label: 'Batik village + try-your-own workshop (5h)', idr: 700000 },
      { label: 'Batik + Imogiri royal tombs (full day)',     idr: 1000000 },
    ],
    includes: ['jeep + driver', 'fuel', 'hotel/villa pickup + dropoff'],
    excludes: ['batik purchases', 'workshop materials fee', 'tolls + bridge fees', 'parking', 'food (guests + driver)'],
    imageUrl: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2007_47_15%20PM.png',
  },
  {
    id:          'zoo',
    label_en:    'Zoo',
    label_id:    'Kebun Binatang',
    description: 'Gembira Loka Zoo jeep transport — driver waits during your visit.',
    rate_model:  'per_destination_package',
    header:      'Gembira Loka Zoo day trip',
    subtext:     'Jeep ride to Gembira Loka Zoo on the east side of Yogyakarta. Driver waits during your visit and rides you home. Family-friendly half-day with kid-safe transport. Hotel/villa pickup + dropoff included.',
    default_rates: [
      { label: 'Gembira Loka half-day (4h)',                idr: 500000 },
      { label: 'Zoo + Affandi museum combo (6h)',           idr: 700000 },
      { label: 'Zoo + Sindu Kusuma waterpark (full day)',   idr: 850000 },
    ],
    includes: ['jeep + driver', 'fuel', 'hotel/villa pickup + dropoff', 'driver waits during visit'],
    excludes: ['zoo entrance tickets', 'food + drinks', 'tolls + bridge fees', 'parking', 'driver meals'],
    imageUrl: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2007_48_47%20PM.png',
  },
  {
    id:          'highland',
    label_en:    'Highland',
    label_id:    'Bukit Senja',
    description: 'Wild hill sunset spots — Punthuk Setumbu, Mangunan, Becici, Klangon.',
    rate_model:  'per_destination_package',
    header:      'Highland sunset jeep',
    subtext:     'Offroad jeep ride to Yogyakarta\'s wild hill sunset spots — Punthuk Setumbu over the Borobudur valley, Mangunan pine forest above the clouds, Becici Pine, or Klangon hill with Merapi backdrop. Rawer vibe than the city-rooftop Sunset package. Hotel/villa pickup + dropoff included.',
    default_rates: [
      { label: 'Punthuk Setumbu (Borobudur valley view)', idr: 700000 },
      { label: 'Mangunan pine forest sunset (4h)',         idr: 600000 },
      { label: 'Becici Pine + Mangunan combo (5h)',        idr: 800000 },
      { label: 'Klangon hill sunset (Merapi view)',        idr: 600000 },
      { label: 'Sunrise variant (pre-dawn pickup)',        idr: 800000 },
    ],
    includes: ['jeep + driver', 'fuel', 'hotel/villa pickup + dropoff', 'flashlight (sunrise)'],
    excludes: ['viewpoint entrance tickets', 'tolls + bridge fees', 'parking', 'food (guests + driver)'],
    imageUrl: 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2007_51_45%20PM.png',
  },
]
