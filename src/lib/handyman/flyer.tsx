...
// 1080×1920 WhatsApp Status flyer for the handyman vertical. Renders a
// PNG server-side via next/og's ImageResponse — no new npm deps, no
// font fetches, deterministic output.
...
export function renderFlyer(input: FlyerInput) {
  ...
  return renderSharedFlyer({
    vertical_slug:  'handyman',
    vertical_label: 'handyman',
