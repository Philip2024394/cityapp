...
const TEMPLATE_IMAGES: Record<string, string> = {
  ...
  'bike-mangunan-sunrise': 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2005_42_42%20PM.png',
  ...
  'bike-market-warung':    'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2006_15_56%20PM.png',
  'bike-nightclubs-bars':      'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2006_19_30%20PM.png',
  'bike-ricefield-restaurant': 'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2006_21_02%20PM.png',
  'bike-souvenir-market':      'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2006_41_06%20PM.png',
  ...
  'bike-traditional-tattoo':   'https://ik.imagekit.io/nepgaxllc/ChatGPT%20Image%20Jun%202,%202026,%2006_39_29%20PM.png',
}
...
export const TOUR_TEMPLATES: ReadonlyArray<TourTemplate> = [
  ...
  {
    id: 'bike-nightclubs-bars',
    vehicle: 'bike',
    title: 'Nightclubs + Bars Loop',
    description: 'Evening ride between the best nightclubs and rooftop bars in Jogja. Driver waits or returns for pickup — your call. Helmet provided.',
    duration_hours: 4, max_pax: 1,
    suggested_price: 250_000, market_floor: 350_000,
    includes: ['rider', 'fuel', 'helmet'],
    excludes: ['cover charges', 'drinks'],
    place_slugs: ['malioboro', 'prawirotaman'],
    tags: ['night', 'nightlife', 'bars'],
  },
  {
    id: 'bike-ricefield-restaurant',
    vehicle: 'bike',
    title: 'Rice-field Restaurant Sunset',
    description: 'Short ride out to a restaurant overlooking the Sleman or Bantul rice fields. Best at golden hour. Driver waits while you eat, then rides you home.',
    duration_hours: 3, max_pax: 1,
    suggested_price: 180_000, market_floor: 250_000,
    includes: ['rider', 'fuel', 'helmet'],
    excludes: ['meal', 'drinks'],
    place_slugs: ['sleman', 'bantul'],
    tags: ['food', 'scenic', 'sunset', 'romantic'],
  },
  {
    id: 'bike-souvenir-market',
    vehicle: 'bike',
    title: 'Souvenir + Gift Market Tour',
    description: 'Daily-market hop across Beringharjo and Pasar Ngasem for batik, snacks, and trinkets to take home. Driver knows which stalls do not over-charge.',
    duration_hours: 3, max_pax: 1,
    suggested_price: 150_000, market_floor: 200_000,
    includes: ['rider', 'fuel', 'helmet'],
    excludes: ['purchases'],
    place_slugs: ['beringharjo', 'malioboro'],
    tags: ['shopping', 'souvenir', 'market', 'culture'],
  },
  {
    id: 'bike-leather-craft',
    vehicle: 'bike',
    title: 'Traditional Leather Handbag Workshop',
    description: 'Ride out to the Manding leather village. Watch artisans hand-stitch bags, wallets, and belts — and order direct from the maker.',
    duration_hours: 4, max_pax: 1,
    suggested_price: 220_000, market_floor: 300_000,
    includes: ['rider', 'fuel', 'helmet'],
  ...
  },
  {
    id: 'bike-city-zoo',
    vehicle: 'bike',
    title: 'Yogyakarta City Zoo Day',
    description: 'Ride to Gembira Loka Zoo, the city zoo on the Yogyakarta east side. Driver waits during your visit + rides you home. Good half-day for families with kids in town.',
    duration_hours: 4, max_pax: 1,
    suggested_price: 180_000, market_floor: 240_000,
    includes: ['rider', 'fuel', 'helmet'],
    excludes: ['zoo entrance fee', 'food'],
    place_slugs: ['gembira-loka', 'yogyakarta'],
    tags: ['family', 'wildlife', 'kids', 'day-trip'],
  },
  {
    id: 'bike-botox-treatment',
    vehicle: 'bike',
    title: 'Aesthetic Clinic Visit (Botox / Filler)',
    description: 'Ride to a licensed aesthetic clinic for a botox or filler appointment. Driver waits outside until your treatment is done, then rides you home. Helmet + jacket provided.',
    duration_hours: 2, max_pax: 1,
    suggested_price: 150_000, market_floor: 200_000,
    includes: ['rider', 'fuel', 'helmet'],
    excludes: ['clinic fee', 'consultation'],
    place_slugs: ['yogyakarta', 'sleman'],
    tags: ['wellness', 'aesthetic', 'medical', 'appointment'],
  },
  {
    id: 'bike-traditional-tattoo',
    vehicle: 'bike',
    title: 'Traditional Indonesian Tattoo Studio Visit',
    description: 'Ride to a hand-poke tattoo studio specialising in traditional Indonesian art — wayang, batik motifs, regional symbols. Driver returns to collect you whenever you message — sessions can run long.',
    duration_hours: 4, max_pax: 1,
    suggested_price: 200_000, market_floor: 280_000,
    includes: ['rider', 'fuel', 'helmet'],
    excludes: ['tattoo fee', 'deposit'],
    place_slugs: ['yogyakarta', 'bantul'],
    tags: ['culture', 'tattoo', 'art', 'traditional'],
  },
