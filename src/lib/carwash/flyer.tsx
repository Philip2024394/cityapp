...
// 1080×1920 WhatsApp Status flyer for the carwash vertical.
// The public profile lives at /car-wash/<slug> — hyphenated path.
...
export function renderFlyer(input: FlyerInput) {
  const services = pickFromFlatPhotos(input.service_photos, {
    ...
    hourlyLabel: 'Starting at',
    dayLabel:    'Detailing paket',
  })
  return renderSharedFlyer({
    vertical_slug:  'car-wash',
    vertical_label: 'car wash',
