...
// platform never custodies funds — CityDrivers is a software directory
// under PM 12/2019.
//
...
export const SUBSCRIPTION_QRIS_ALT =
  'CityDrivers monthly subscription QRIS · Rp 38,000 per month'
...
export const SUBSCRIPTION_QRIS_YEARLY_ALT =
  'CityDrivers yearly subscription QRIS · Rp 350,000 per year'
